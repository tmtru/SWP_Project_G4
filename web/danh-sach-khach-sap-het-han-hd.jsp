    ...
    <body>
        ...
        <section class="home">
            ...
            <section class="property-management">
                <div class="header">
                    <h2>Danh sách khách sắp hết hạn hợp đồng</h2>
                ...
                <div class="filters" style="background-color: #f9f9f9;padding-left: 0px">
                    ...
                    <form action="khach-sap-het-han" method="get" style="display: flex; align-items: center;">
            ...
            <section class="ftco-section">
                ...
                <script>
                    function changePage(page) {
                        window.location.href = "khach-sap-het-han?searchTerm=" + `${param.searchTerm}` + "&page=" + page;
                    }
                </script>
            </section>
