 ...
 * @author Admin
 */
public class RoleFilterTQAT implements Filter {
    ...
    public RoleFilterTQAT() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("RoleFilterTQAT:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("RoleFilterTQAT:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean isAllowedPage = uri.equals("/home.jsp") || uri.equals("/category.jsp") || uri.equals("/changePassword.jsp") || uri.equals("/confirmverification.jsp")
                ...
                || uri.equals("/allrooms") ||  uri.equals("/allrooms.jsp") || uri.equals("/filterrooms") || uri.equals("/feedback")|| uri.equals("/roomdetails");
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("RoleFilterTQAT:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("RoleFilterTQAT()");
        }
        StringBuffer sb = new StringBuffer("RoleFilterTQAT(");
