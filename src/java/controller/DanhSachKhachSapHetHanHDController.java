 ...
 * @author Admin
 */
@WebServlet(name = "DanhSachKhachSapHetHanHDController", urlPatterns = {"/khach-sap-het-han"})
public class DanhSachKhachSapHetHanHDController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<HopDong> hopdongs = hddao.getHopDongKhachSapHetHanByApartment(currentHouseId, searchTerm, start, ACCOUNTS_PER_PAGE);
        int total = hddao.getHopDongKhachSapHetHanByApartment(currentHouseId, searchTerm, null, ACCOUNTS_PER_PAGE).size();
        ...
        request.getRequestDispatcher("danh-sach-khach-sap-het-han-hd.jsp").forward(request, response);
    }
