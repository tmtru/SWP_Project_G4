 ...
 * @author Admin
 */
@WebServlet(name = "DanhSachKhachCocController", urlPatterns = {"/khach-coc"})
public class DanhSachKhachCocController extends HttpServlet {
private static final int ACCOUNTS_PER_PAGE = 10; 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<HopDong> hopdongs = hddao.getHopDongKhachCocByApartment(currentHouseId, searchTerm, start, ACCOUNTS_PER_PAGE);
        int total = hddao.getHopDongKhachCocByApartment(currentHouseId, searchTerm, null, ACCOUNTS_PER_PAGE).size();
        ...
        request.getRequestDispatcher("danh-sach-khach-coc.jsp").forward(request, response);
    }
